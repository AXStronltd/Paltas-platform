...
const UNGUARDED_BY_DESIGN = {
  ...
  "/public/destinations/route.ts": "the shopfront's own index of where it has inventory — city, country, a centroid averaged from published listings, and how many. Public by design, and it reveals nothing a visitor could not learn by browsing the catalogue itself. It reads only PUBLISHED listings and writes nothing.",
